...
if {$tech_lib == $tsmc18_tech_lib} {
  set_dont_use [list $library_name/DLY* ]
  set sdf_version "1.0"
}

if {$tech_lib == $tsmc065_tech_lib} {
  set_dont_use [list $library_name/DEL* ]
}

if {$tech_lib == $saed32nm_tech_lib} {
  set_dont_use [list $library_name/*X0* ]
  set_dont_use [list $library_name/*X1* ]
}
