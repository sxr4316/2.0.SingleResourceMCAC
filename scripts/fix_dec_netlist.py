...
netlist_path = '../dec/netlist/dec_tsmc065_scan/*.vs'

keywords = ['boot_mem128_test_1 ', 'test_module_test_1 ']

change_dict = {
	'boot_mem128_test_1 ' : 'boot_mem128 ',
	'test_module_test_1 ' : 'test_module '
}
