/*
  ===========================================================================
   File: COUNT.C                                         v.2.2 - 06.Dec.2006
  ===========================================================================
...
static Word16 funcid[MAXCOUNTERS];
static Word32 nbframe[MAXCOUNTERS]; /* modified from Word16 -> Word32 by Csaba Kos (NTT-AT) 2008/4/25. */
...
void WMOPS_output (Word16 dtx_mode) {
    ...
    fprintf (stdout, "%s: Last      wmops = %.5f ( %d frames)\n",
	     objectName[currCounter]?objectName[currCounter]:"",
	     ((float) tot) * frameRate,
	     nbframe[currCounter]);
    ...
    {
        fprintf (stdout, "%s: Averaged  WMOPS = %.5f ( %d frames)\n",
	         objectName[currCounter]?objectName[currCounter]:"",
                 tot_wm / (float) nbframe[currCounter],
                 nbframe[currCounter]);
    }
    fprintf (stdout, "%s: WorstCase WMOPS = %.5f ( %d frames)\n",
	     objectName[currCounter]?objectName[currCounter]:"",
    ...
    if (dtx_mode == 0)
    {
        ...
        fprintf (stdout, "%s: WorstWC   wmops = %.5f ( %d frames)\n",
	         objectName[currCounter]?objectName[currCounter]:"",
    	         ((float) tot_wc) * frameRate,
                 nbframe[currCounter]);
    }
