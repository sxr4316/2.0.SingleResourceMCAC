...
void openFiles()
{
	...
	snprintf(fileDir, sizeof(fileDir), "%sd.t", outPath);
	f_d = fopen(fileDir, mode);
	snprintf(fileDir, sizeof(fileDir), "%sdl.t", outPath);
	f_dl = fopen(fileDir, mode);
	snprintf(fileDir, sizeof(fileDir), "%sdln.t", outPath);
	f_dln = fopen(fileDir, mode);
	...
	snprintf(fileDir, sizeof(fileDir), "%sds.t", outPath);
	f_ds = fopen(fileDir, mode);
	...
	snprintf(fileDir, sizeof(fileDir), "%ssl.t", outPath);
	f_sl = fopen(fileDir, mode);
	...
	snprintf(fileDir, sizeof(fileDir), "%sss.t", outPath);
	f_ss = fopen(fileDir, mode);
...
void printVars()
{
	...
	fprintf(f_d, "@%04X\t%06X\n", clockCount, d);
	fprintf(f_dl, "@%04X\t%06X\n", clockCount, dl);
	fprintf(f_dln, "@%04X\t%06X\n", clockCount, dln);
